    ...
    return (
        <div className='mx-10'>
            <div className='flex justify-between'>
                <div>
                  <h1 className="textColor"><span className="font-bold">Different</span> Experiences <br /> with  <span className="font-bold">Ovigo</span></h1>
                </div>
                <div className='text-black flex items-center justify-center'>
                    <CiLocationArrow1 className='text-9xl textColor mr-10 text-black'/>
                    <span className='text-2xl text-gray-500'>First Ever Bangladesh Activity tour <br />where you get actual refreshment</span> 
                </div>
            </div>
            <div className='flex justify-between'>
                <div>
                <select className="bg-white w-80 text-gray-500 border p-2 rounded-lg">
